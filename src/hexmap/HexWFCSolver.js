/**
 * HexWFCSolver - pure WFC algorithm kernel (cube-coordinate based).
 *
 * Extracted from the Web Worker (wfc.worker.js) so it can run headlessly in
 * Node and be lifted verbatim into the Godot migration target. Free of any
 * Three.js / `?worker` / DOM dependency; depends only on HexWFCCore,
 * HexTileData and SeededRandom (plain data / pure logic).
 */
...
import { TILE_LIST, HexDir, HexOpposite, LEVELS_COUNT } from './HexTileData.js'
